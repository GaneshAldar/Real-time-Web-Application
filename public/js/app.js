...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var pizza = JSON.parse(btn.dataset.pizza); // parse converts the json string to object i.e.(pizza string)

    updateCart(pizza);
  });
}); // Remove alert message after X seconds in customer order
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_1__.loadStripe)('pk_test_51IMDFVBJl7R2JO3Izc9LCacyFZtowj6quX4Qo0pcsyBZxdAzI6HtblGaYTmTmVRrQ9zc36HGOSrBSkmSMwPmGX7800tXIiC46G');
